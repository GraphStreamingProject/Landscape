...
yes | bash setup_tagged_workers.sh $region 36 8
bash scale_experiment.sh $result_file 32 32 1 7 'Cube + Standalone'

python3 aws/run_first_n_workers.py --num_workers 48
yes | bash setup_tagged_workers.sh $region 36 8
bash scale_experiment.sh $result_file 48 48 1 11 'Cube + Standalone'
...
python3 aws/run_first_n_workers.py --num_workers 32
yes | bash setup_tagged_workers.sh $region 36 8
bash scale_experiment.sh $result_file 32 32 1 7 'Cameo + Standalone'

python3 aws/run_first_n_workers.py --num_workers 48
yes | bash setup_tagged_workers.sh $region 36 8
bash scale_experiment.sh $result_file 48 48 1 11 'Cameo + Standalone'
