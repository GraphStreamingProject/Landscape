...
cat /proc/net/dev > $FILE_NAME
mpirun -np 61 -hostfile hostfile -rf rankfile ./query_expr 40 60 /mnt/ssd1/kron_17_stream_binary $FILE_NAME --repeat 9 --burst 10 100000
cat /proc/net/dev >> $FILE_NAME


FILE_NAME=results/query_expr_bursts_point
cat /proc/net/dev > $FILE_NAME
mpirun -np 61 -hostfile hostfile -rf rankfile ./query_expr 40 60 /mnt/ssd1/kron_17_stream_binary $FILE_NAME --repeat 9 --burst 10 100000 --point
cat /proc/net/dev >> $FILE_NAME
